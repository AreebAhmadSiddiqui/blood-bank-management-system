...
function Navbar() {
  return (
    <div className='nav'>
        <NavLink to={'/blood-bank-management-system'} style={{ 'textDecoration': 'none', 'color': 'white' }}><h1>Blood Bank Management System</h1></NavLink>
      <ul>
        <NavLink to={'/blood-bank-management-system'} style={{ 'textDecoration': 'none', 'color': 'white' }}>Home</NavLink>
