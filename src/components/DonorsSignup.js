...
function DonorsSignup() {
  ...
  const getLocalStorageItems = () => {
    const data = localStorage.getItem('donor')
  ...
  useEffect(() => {
    if(isAuthenticated===true) navigate('../donor');
  }, [isAuthenticated])

  useEffect(() => {
    localStorage.setItem('donor', JSON.stringify(donorsData))
  }, [donorsData])
